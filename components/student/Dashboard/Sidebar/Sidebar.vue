<template>
  <Transition name="slide-right">
    <div
      v-show="showSideMenu"
      id="side-menu"
      class="sticky left-0 top-16 flex h-[calc(100dvh-4rem)] w-[calc(20%)] min-w-40 flex-col items-start justify-start border-r border-neutral-300 pt-4 dark:border-neutral-600"
    >
