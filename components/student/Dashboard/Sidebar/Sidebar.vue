<template>
  <Transition name="slide-right">
    <div
      v-show="showSideMenu"
      id="side-menu"
      class="sticky left-0 top-16 z-10 flex h-dvh w-[38%] flex-col items-start justify-start border-r border-neutral-300 pt-4 md:w-48 lg:w-64 dark:border-neutral-600"
    >
