<template>
  <div
    class="flex w-full items-center justify-center gap-2 rounded-2xl border border-[var(--border-color)] p-6"
    :class="{ 'cursor-pointer transition hover:bg-gray-accent hover:dark:bg-dark-hover': clickable }"
  >
