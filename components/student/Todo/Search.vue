<template>
  <div
    class="flex h-9 w-36 items-center justify-center rounded-full border border-neutral-300 bg-white p-3 transition duration-500 focus:border-2 focus:border-neutral-600/50 lg:w-72 dark:border-neutral-700 dark:bg-neutral-800 dark:hover:border-neutral-600"
  >
    <span class="">
