<template>
  <div
    ref="toolbar"
    class="sticky top-20 mt-4 flex items-center justify-center gap-4 rounded-full border-transparent bg-body px-5 py-2 transition duration-500 sm:flex-wrap xl:flex-nowrap"
