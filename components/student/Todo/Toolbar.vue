<template>
  <div
    ref="toolbar"
    class="bg-body sticky top-20 z-[2] mt-4 flex flex-wrap items-center justify-center gap-4 rounded-full border-transparent px-5 py-2 transition duration-500 xl:flex-nowrap"
