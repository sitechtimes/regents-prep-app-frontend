<template>
  ...
  >
    ...
    <div class="flex h-full min-h-36 w-full columns-2 bg-[var(--bg-color)] p-2">
      <div class="w-full">
        <div class="h-16 text-center text-xl font-bold"><h3 class="self-center pt-3 underline">Class Code</h3></div>
      </div>
      <div class="divider divider-dark-border"></div>
      <div class="w-full">
        <div class="h-16 text-center text-xl font-bold"><h3 class="self-center pt-3 underline">Students in class</h3></div>
      </div>
