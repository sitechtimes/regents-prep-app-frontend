      ...
      <div class="flex h-full w-full flex-wrap items-start justify-around gap-7" v-if="course.assignments.length > 0">
        ...
        >
          ...
          <div class="flex h-full w-full flex-col items-center justify-start">
            ...
            >
            <div @click.stop="router.push(`/teacher/course/${course.id}/${assignment.id}`)" class="relative flex h-full w-full items-center overflow-hidden rounded-full bg-[var(--gray)]">
