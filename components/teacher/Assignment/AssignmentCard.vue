<template>
  ...
  >
    ...
    <div class="mt-2 text-center">
      ...
      <div class="mt-1 inline-block rounded-full border border-gray-400 px-2 py-1 dark:border-gray-500">{{ assignment.numSubmitted }}/{{ course.numStudents ?? 0 }} Students</div>
    </div>
  </div>
</template>
