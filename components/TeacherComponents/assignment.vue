...
<template>
  ...
  >
    ...
    <div
      class="flex-col items-center text-center place-content-center justify-center flex right-0 rounded-[73.50px] shadow-innervar shadow-black bg-[#8B9930] h-[57px] w-[107px]"
    >
      <h3
        id="dueDate"
