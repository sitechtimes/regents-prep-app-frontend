<template>
  <div class="du-dropdown du-dropdown-end du-dropdown-hover">
    <img tabindex="0" role="button" class="btn m-1 h-6 w-6 dark:invert" src="/ui/user.svg" alt="Open account settings" />
    <ul tabindex="0" class="du-dropdown-content z-[1] mt-2 w-52 rounded-lg border border-[var(--border-color)] bg-[var(--bg-color)] p-2 shadow">
