<h1 align="center">Unregents Prep App</h1>
...
<ul>
    ...
    <li>daisy ui (i'm too lazy to format the list...)</li>
</ul>

## DaisyUI

this project uses [daisyui](https://daisyui.com/), a tailwind ui library

daisyui classes have the prefix `du-` so you can use [this vscode extension](https://marketplace.visualstudio.com/items?itemName=emranweb.daisyui-snippet) to get snippets
