  ...
  <div>
    <nav class="h-[109px] 2w-screen bg-[#EAE9CA] shadow">
      <div class="flex flex-row">
        <div
          id="teacherName"
          class="w-[355px] h-[70px] mt-[12px] pl-[1%]"
        >
          <div
        ...
        <div class="m-auto">
          ...
          >
            <div
              class="w-[277px] h-[73px] bg-[#426B1F] rounded-[24px]"
            >
              <h1
                class="w-[277px] h-[73px] text-center text-white text-[50px] font-medium place-self-center"
              >
                Dashboard
              </h1>
            </div>
        ...
        <div
          id="logout-btn"
          class="w-[355] h-[69px] mt-[20px] pr-[1%] pl-[2%]"
        >
          <button
