      ...
      <div class="flex w-full flex-col">
        ...
        <div v-else class="flex h-full w-full items-center justify-center overflow-hidden">
          <div class="flex flex-col items-center gap-4">
            ...
            <button class="mt-4 rounded-lg bg-green-accent px-4 py-2 text-white transition duration-300 hover:bg-gray-600" type="button" @click="showCreateClass = true">Create Class</button>
          </div>
        </div>
