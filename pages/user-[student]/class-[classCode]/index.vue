...
<template>
  <div class="h-fit bg-bg-reg">
    ...
    >
      <div class="h-[60px] w-[470px] text-[35px] ml-[80px] mt-[15px] flex items-center bg-bg-light rounded-[27px]">
        ...
        <div class="w-[80%] right-[0%] text-center m-auto">{{ toggle }} Assignments</div>
      </div>
      ...
      <button
        v-if="PastStatus"
        class="h-[60px] w-[370px] text-[35px] mr-[100px] mt-[15px] text-center text-white bg-secondary rounded-[27px]"
      >
        View Statistics
      </button>
    </div>
