<template>
  <div class="flex h-full w-full flex-col items-center justify-center">
    <h2 class="text-3xl mt-6">Assignment Statistics</h2>
      ...
      <table class="table-auto w-full border-collapse border border-gray-300">
        <thead>
          <tr>
            ...
            <th class="border border-gray-300 px-4 py-2">Answer Type</th>
        ...
        <tbody>
          <tr
            ...
            class="hover:bg-green-300 text-center"
          >
            <td class="border border-gray-300 px-4 py-2 text-center">
              {{ index + 1 }}
            </td>
            <td class="border border-gray-300 px-4 py-2" v-html="questionInstance.question.text"></td>
